/*
* Class implementation for Goshawk with "fake" quadrotor dynamics
*
...
AGoshawkPawn_fake::AGoshawkPawn_fake()
{
...
void AGoshawkPawn_fake::PostInitializeComponents()
{
...
void AGoshawkPawn_fake::BeginPlay()
{
    _vehicle->BeginPlay();
...
void AGoshawkPawn_fake::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
    _vehicle->EndPlay();
...
void AGoshawkPawn_fake::Tick(float DeltaSeconds)
{
    _vehicle->Tick();
