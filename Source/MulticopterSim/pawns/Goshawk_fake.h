/*
* Class declaration for Goshawk class with "fake" quadrotor dynamics
*
...
#include "Goshawk_fake.generated.h"

UCLASS(Config=Game)
class MULTICOPTERSIM_API AGoshawkPawn_fake : public APawn {
