...
writing is UE4.23. To install UE4, follow these [instructions](https://docs.unrealengine.com/en-US/GettingStarted/Installation/index.html).
...
2. Clone the  [HackflightQuadModule](https://github.com/simondlevy/MulticopterSim/tree/HackflightQuadModule) branch
