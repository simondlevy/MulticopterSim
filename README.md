...
3. In Visual Studio, edit the [file](https://github.com/simondlevy/MulticopterSim/blob/HackflightModule/FlightModule.Build.cs#L16-L17) to reflect where you installed Hackflight.

4. In VisualStudio, hit the F5 key to build the project and launch UnrealEditor.

## Linux

1. Edit the [file](https://github.com/simondlevy/MulticopterSim/blob/HackflightModule/FlightModule.Build.cs#L16-L17) to reflect where you installed Hackflight.
